...
export const seo = {
    ...
    description:
        `Full-Stack & Mobile Developer based. I build production-grade SaaS products, backend infrastructure, and native mobile applications with ${calculatedYears}+ years of experience.`,
